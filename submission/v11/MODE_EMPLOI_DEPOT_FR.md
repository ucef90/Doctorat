...
| Déclarations | Financement, conflits d'intérêts, assistance IA, disponibilité du code et des données, approbation des auteurs | À confirmer ; le texte ne doit pas attribuer un accord qui n'a pas encore été obtenu |
